...
export class Message extends Model {
    ...
    getViewElement(me = true) {
        ...
        switch(this.type) {
                                                    ...
                                                    <div class="_2jfIu">
                                                        <div class="_2cfqh">
                                                            <div class="_1QMEq _1kZiz fS1bA">
                                                                <div class="E5U9C">
                                                                    <svg class="_ audio-load" width="34" height="34" viewBox="0 0 43 43">
                                                                        <circle class="_3GbTq _37WZ9" cx="21.5" cy="21.5" r="20" fill="none" stroke-width="3"></circle>
                                                                    </svg>
            ...
            default:  
                 div.innerHTML = `
                                            <div class="font-style _3DFk6" id="${this._data.id}"> <span class="tail-container"></span>
                                                <span class="tail-container highlight"></span>
                                                <div class="Tkt2p">
                                                    <div class="_3zb-j ZhF0n">
                                                        <span dir="ltr" class="selectable-text invisible-space message-text">${this._data.content}</span>
                                                    </div>
                                                    <div class="_2f-RV">
                                                        <div class="_1DZAH">
        ...
        return new Promise((s, f) => {
            Message.send(chatId, from, 'document', '').then(msgRef => {
                ...
                Message.upload(file, from).then(downloadURL => {
                    ...
                    if (filePreview) {
                        Message.upload(filePreview, from).then(previewURL => {
                            msgRef.set({
                                content: downloadURL,
                                preview: previewURL,
                                filename: file.name,
